...
juntarPlanillas' :: Planilla -> Planilla -> Planilla
juntarPlanillas' otraPlanilla Fin = otraPlanilla
juntarPlanillas' planilla (Registro nombre1 planilla1) = Registro nombre1 (juntarPlanillas' planilla planilla1) 


juntarPlanillas'' :: Planilla -> Planilla -> Planilla
juntarPlanillas'' Fin otraPlanilla = otraPlanilla
juntarPlanillas'' (Registro nombre1 planilla1) otraPlanilla = Registro nombre1 (juntarPlanillas'' planilla otraPlanilla) 
